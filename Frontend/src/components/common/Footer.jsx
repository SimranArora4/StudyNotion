        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link to='http://github.com/SimranArora4' target="__blank" className="text-white hover:underline mx-1"
              >
               Simran Arora
              </Link>
            </div>
          ...
          <div className="flex items-center">
            <a href="https://www.linkedin.com/in/simran-arora-28125b258/" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="http://github.com/SimranArora4" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
          </div>
